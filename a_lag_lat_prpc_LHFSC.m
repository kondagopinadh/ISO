...
%%%%%%%%%  MCONV %%%%%%%%%%%%
mp=('J:\Data\Models_CMIP5\lhf\BP_filt_lhf\JJAS_files\');
ofile=[mp,'M_Re_Ind_JJAS_LHFS_filt_MERRA_1980-2005.mat'];
ol=load(ofile);
olr=ol.lhfs;
olon=ol.lon;
olat=ol.lat;
...
levels1=[-0.4 -0.8 -1.2 -1.6]';
[c h]=contour(lag1,olat3,olrr,levels,'-b','linewidth',0.8);
clabel(c,h,'FontSize',8,'Color','b','labelspacing',900)
[c h]=contour(lag1,olat3,olrr,levels1,'-k','linewidth',0.8);
...
set(h, 'Position',[.93 .212 .01 .6],'FontSize',16,'Fontweight','normal','TickDir','In');
  % print(1,'-dtiff','Regress_AS_lag_lat_PRCP_LHFSC.tif','-r600');
